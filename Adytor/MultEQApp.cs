...
namespace Adytor
{
    public class MultEQApp : MultEQLists, INotifyPropertyChanged
    {
        // according to JSON definition of .ady file
        ...
        //If false, all inputs are disabled
        private bool _UiAmpSettingsEnabled = false;
        //If false, all channel related input fields are disabled
        private bool _UiChannelSettingsEnabled = false;
        //
        private ObservableCollection<AdytorCurve> _targetCurveApplyCollection = new ObservableCollection<AdytorCurve>();
        private AdytorCurve _selectedAdytorCurve;

        #region Properties
        [JsonIgnore]
        public ObservableCollection<AdytorCurve>TargetCurveApplyCollection
        {
            get
            {
                return _targetCurveApplyCollection;
            }
            set
            {
                _targetCurveApplyCollection = value;
                RaisePropertyChanged("TargetCurveApplyCollection");
            }
        }
        [JsonIgnore]
        public AdytorCurve SelectedAdytorCurve
        {
            get
            {
                return _selectedAdytorCurve;
            }
            set
            {
                _selectedAdytorCurve = value;
                RaisePropertyChanged("SelectedAdytorCurve");
            }
        }
        [JsonIgnore]
        public bool UiAmpSettingsEnabled
        {
            get
            {
                return _UiAmpSettingsEnabled;
            }
            set
            {
                _UiAmpSettingsEnabled = value;
                RaisePropertyChanged("UiAmpSettingsEnabled");
            }
        }
        [JsonIgnore]
        public bool UiChannelSettingsEnabled
        {
            get
            {
                return _UiChannelSettingsEnabled;
            }
            set
            {
                _UiChannelSettingsEnabled = value;
                RaisePropertyChanged("UiChannelSettingsEnabled");
            }
        }
